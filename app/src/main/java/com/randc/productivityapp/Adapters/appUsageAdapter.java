        ...
        holder.distributionItemLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                if (list.get(position).isWaveType()) {
                    holder.distributionWave.setWaveColor(Color.parseColor("#26978C"), Color.parseColor("#21e8c7"));
                    if (change >= 0.25f) {
                    ...
                    holder.distributionWave.setWaveColor(Color.parseColor("#953F53"), Color.parseColor("#f03145"));
                    if (change >= 0.25f) {
